            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <form action="{{ route('admin.users.update', $user) }}" method="POST">
                        @csrf
                        {{-- Method PUT wajib digunakan untuk resource route 'update' di Laravel --}}
                        @method('PUT')
                        ...
                        <div class="mb-4 p-4 bg-gray-50 rounded-lg border border-gray-200">
                            <h4 class="text-sm font-semibold text-gray-800 mb-2">Pembaruan Password (Opsional)</h4>
                            <p class="text-xs text-gray-500 mb-4">Biarkan kolom di bawah ini kosong jika Anda tidak ingin mengubah password user ini.</p>
                            
                            <div class="mb-4">
                                <label for="password" class="block text-sm font-medium text-gray-700">Password Baru</label>
                                <!-- Hapus atribut required karena field ini opsional -->
